...
const pacientes_resolver_1 = require("./pacientes.resolver");
...
exports.PacientesModule = PacientesModule = __decorate([
    (0, common_1.Module)({
        providers: [pacientes_resolver_1.PacientesResolver, pacientes_service_1.PacienteService],
        imports: [
            typeorm_1.TypeOrmModule.forFeature([paciente_entity_1.Paciente]),
        ],
        exports: [pacientes_service_1.PacienteService]
    })
], PacientesModule);
